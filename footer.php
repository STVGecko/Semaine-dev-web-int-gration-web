<footer>
	<div class="wrap_footer">
      <div class="logo_footer">
	          ...
	          <p class="big_font">d’aujourd’hui</p>
				...
				<div class="block">
					<p class="big_font0">Coordonnées</p>
						...
						<p class="mail-replace"><?php $mail=get_field('mail', get_option( 'page_on_front' )); echo(str_replace("@", "arobaze", $mail)); ?></p>
				</div>
				<div class="block">
	      ...
	      <div class="block">
	          <p class="fine_font"><a href="<?php $copi=get_field('lmention', get_option( 'page_on_front' )); echo $copi; ?>">Mentions légales</a></p>
