...
if(isset($_POST['Envoyer'])) {
   if(!empty($_POST['nom']) AND !empty($_POST['prenom']) AND !empty($_POST['mail']) AND !empty($_POST['message']) AND !empty($_POST['telephone'])) {
      ...
      wp_mail("$receptionmail = get_field('telephone', get_option('page_on_front')); echo $receptionmail", "Formulaire du devis", $message, $headers);/*remplacer expediteur par notre mail si jamais*/
