...
<section id="contact_page">
  ...
  <div id="devis_contact">
    ...
    <p style="display: flex; justify-content: center; color: #c00a23; font-size: 18px; font-family: 'Mukta Mahee', sans-serif; width: 50%; text-align: center; margin: 0 auto; text-shadow: -1px 0 black, 0 1px black,1px 0 black, 0 -1px black, padding-top: 10px;">
      <?php if(isset($msg)) {
           echo $msg;
        }
        ?>
