...
<section id="contact_page">
  ...
  <div id="devis_contact">
    ...
    <p style="display: flex; justify-content: center; color: grey; font-size: 18px; font-family: 'Mukta Mahee', sans-serif; width: 50%; text-align: center; margin: 0 auto; padding-top: 10px; border: solid 2px black">
      <?php if(isset($msg)) {
           echo $msg;
        }
        ?>
